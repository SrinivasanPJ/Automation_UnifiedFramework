...
public class CheckingAccount extends BasePage {
    ...
    private WebElement addedBundleContinueButton;
    ...
    private WebElement enterManualDetails;
    ...
    @FindBy(xpath = "//h1[normalize-space()='Residential Address']")
    private WebElement residentialAddrHeader;
    ...
    **/
    public void homepage() throws InterruptedException {
        if (isDisplayed(homeCataloguePage)) {
            ...
            log("home Catalogue is displaying");
        }
    }
    ...
    **/
    public void selectMaxCheckingPlan() throws InterruptedException {
        scrollToBottom();
        waitUntilClickable(selectMaxChecking);
     ...
     **/
    public void bundlePage() throws InterruptedException {
        waitUntilClickable(letsBundleButton);
        click(letsBundleButton, "Let's Bundle is Clicked");
        waitUntilClickable(addedBundleContinueButton,60);
        click(addedBundleContinueButton, "Bundle Confirmed");
    }
     ...
     **/
    public void startApplicationPage() throws InterruptedException
    {
        scrollToBottom();
        click(startApplicationButton, "Start Application is Clicked");
    }
     ...
     * Clicks the "Continue" button
     **/
    public void personalInformationPage() throws InterruptedException
    {
        waitUntilVisible(residentialAddrHeader, 80);
