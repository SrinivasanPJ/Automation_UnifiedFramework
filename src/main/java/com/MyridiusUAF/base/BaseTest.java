...
//    protected RegisterPage registerPage;
    ...
    protected AccountSelectionPage accountSelectionPage;
    protected StartApplicationPage startApplicationPage;
    protected TermsConditionsPage termsConditionsPage;
    protected AccountPaymentPage accountPaymentPage;
    ...
    public void executeTestForTestID(String testID, ITestContext context) {
        ...
        startApplicationPage = new StartApplicationPage();
        termsConditionsPage = new TermsConditionsPage();
        accountPaymentPage = new AccountPaymentPage();
